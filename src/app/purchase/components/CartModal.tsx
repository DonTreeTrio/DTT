...
const STYLES = {
    ...
    title: "text-lg sm:text-xl font-bold text-[#000000]",
    ...
    itemName: "font-medium text-[#000000] text-sm sm:text-base truncate",
    itemPrice: "text-[#179653] font-semibold text-sm sm:text-base",
    quantityContainer: "flex items-center gap-1 sm:gap-2 mt-2",
    quantityButton:
        "w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full border border-[#179653] text-[#179653] hover:bg-[#179653]/10 transition-colors text-sm sm:text-base",
    ...
    totalLabel: "text-[#000000] text-sm sm:text-base",
    totalAmount: "text-lg sm:text-xl font-bold text-[#179653]",
    checkoutButton:
        "w-full bg-[#179653] hover:bg-[#179653]/90 text-white py-2.5 sm:py-3 rounded-lg transition-colors font-medium text-sm sm:text-base",
