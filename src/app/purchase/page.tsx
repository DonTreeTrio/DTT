...
const STYLES = {
    ...
    title: "text-xl sm:text-2xl font-bold text-[#000000]",
    searchContainer: "relative w-full max-w-md",
    searchInput:
        "w-full p-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#179653] focus:border-[#179653] outline-none transition-all",
    searchIcon: "absolute left-3 top-1/2 transform -translate-y-1/2 text-[#179653]",
    ...
    categoryButtonActive: "bg-[#179653] text-white",
    ...
    cardContent: "p-4",
    productName: "text-lg font-bold text-[#000000] mb-1",
    description: "text-sm text-gray-600 mb-2 line-clamp-2",
    price: "text-lg font-semibold text-[#179653] mb-3",
    button: "w-full bg-[#179653] hover:bg-[#179653]/90 text-white px-4 py-2 rounded-lg transition-colors duration-300 font-medium",
    footer: "fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 flex justify-between items-center",
    cartSummary: "text-lg font-bold text-[#179653]",
    checkoutButton:
        "bg-[#179653] hover:bg-[#179653]/90 text-white px-6 py-2 rounded-lg transition-colors duration-300 font-medium",
    pointBadge: "bg-[#179653]/10 text-[#179653] px-3 py-1 rounded-full text-sm font-medium",
};
